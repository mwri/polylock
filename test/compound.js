...
/**
 * Soak test using three resources and random locks. Make all the random decisions
 * up front, and create a 'plan' so the test is exactly repeatable multiple times.
 */
